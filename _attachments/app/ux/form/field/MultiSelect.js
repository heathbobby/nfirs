Ext.define('Ext.ux.form.field.MultiSelect',{
    ...
    requires: ['Ext.util.DelayedTask', 'Ext.EventObject', 'Ext.view.BoundList', 'Ext.view.BoundListKeyNav', 'Ext.data.StoreManager', 'Ext.ux.layout.component.field.MultiSelect'],
    alternateClassName: 'Ext.form.ComboBox',
    alias: ['widget.uxmultiselect'],
    mixins: {
        bindable: 'Ext.util.Bindable'    
    },

    componentLayout: 'uxmultiselect',
    ...
    fieldSubTpl: [
        ...
        '<input id="{id}" type="{type}" {inputAttrTpl} class="{fieldCls} {typeCls} {editableCls}" autocomplete="off"',
            ...
            '/>',
        '<div class="{fieldCls} {tgtTplCls}" role="presentation"></div>',
        {
            compiled: true,
            disableFormats: true
        }
